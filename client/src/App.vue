  ...
  <footer class="footer glass">
    <div class="container footer-grid">
      <div class="footer-brand">
        <h3 class="gradient-text">Ariano store</h3>
        <p>The elite ecosystem for industrial shopping and manufacturing assets.</p>
      </div>
      <div>
        <h4>Company</h4>
        <p>About Us</p>
    ...
    <div class="footer-bottom">
      <p>&copy; 2026 Ariano store. All rights reserved.</p>
    </div>
  </footer>
</template>

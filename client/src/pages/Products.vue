...
<template>
  <div class="products-page container">
    <header class="catalog-header animate-up">
      <h1 class="gradient-text">Products Available</h1>
    ...
    <div class="catalog-layout">
      ...
      <main class="catalog-main">
        <div class="catalog-toolbar glass flex">
        ...
        <div v-else class="product-grid mt-20">
...
<style scoped>
.products-page { padding: 4rem 0; }
.catalog-header { margin-bottom: 4rem; text-align: center; }
.catalog-header h1 { font-size: 3.5rem; margin-bottom: 1rem; }
.catalog-toolbar{}
...
.filters h3 { margin-bottom: 2rem; font-size: 1.25rem; }
...
.page-header h1 { font-size: 3.5rem; letter-spacing: -2px; font-weight: 900; }
...
.filters h3 { margin-bottom: 2rem; font-size: 1.25rem; font-weight: 800; }
...
.cat-item:hover { background: #f8fafc; color: var(--text-primary); }
.cat-item.active { background: #eff6ff; color: var(--accent-blue); }

.view-options { display: flex; gap: 1rem; margin-bottom: 3.5rem; }
.view-options button {
...
.view-options button:hover { border-color: var(--text-muted); }
...
.p-price { 
  font-size: 1.5rem; font-weight: 900;
   font-family: 'Outfit'; color: var(--text-primary);
   }
...
.skeleton-card { height: 400px; border-radius: 28px; background: white; }

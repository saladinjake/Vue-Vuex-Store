...
const stats = [
    ...
    { label: 'Shopping Volume', value: '$248.5k', growth: '+15%', icon: BarChart3 },
  ...
  <div class="dashboard-container">
    <div class="container dash-layout">
      ...
      <aside class="dash-sidebar glass">
        ...
        <button class="btn-logout" @click="handleLogout"><LogOut :size="18" /> Logout</button>
      </aside>

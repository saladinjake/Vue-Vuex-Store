...
<template>
  <div class="cart-page container">
    <header class="cart-header animate-up">
      <h1 class="gradient-text">shopping basket</h1>
    ...
    <div v-if="cartItems.length > 0" class="cart-layout animate-up">
      ...
      <aside class="cart-summary glass">
        ...
        <div class="trust-badge">
          <ShieldCheck :size="18" />
          <span>Verified Business Transaction</span>
        </div>
      </aside>
    </div>
    ...
    <div v-else class="empty-cart glass-card animate-up">
      ...
      <p>Explore our premium catalog to add industrial assets to your shopping project.</p>

    ...
    <header class="hero">
      ...
      <div class="container hero-content animate-up">
        <div class="hero-text">
          ...
          <h1>Powering the <span class="gradient-text">Global Supply Chain</span> with Insights</h1>
          <p>Seamless shopping, verified vendors, and industrial-grade logistics for enterprise-level operations.</p>
          <div class="hero-ctas">
